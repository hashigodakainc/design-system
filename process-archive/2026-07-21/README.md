...
01〜09のHTMLは一時プレビューに残っていた最終状態のスナップショットである。10はImagegenの
比較画像とフィードバックから、モチーフ探索の主要な判断段階を再構成した。00は、第三者の
...
| 10 | [`10-motif-exploration/`](10-motif-exploration/) | 写真を使わない場面の固有モチーフを比較する | H由来の直接表現から、二形状と共有負形、ロケットの肯定的な物語、黄金比と重心調整を経て06R-1ABへ至る主要14段階 | `a9f8c9f`〜`4156650`とImagegen比較画像 |
...
- 公開対象は00〜10の11段階の比較HTML、判断の時系列、それらが現在参照するローカルフォント・
  ライセンスである。
